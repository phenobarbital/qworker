...
**Date**: 2026-05-26
**Notes**: All 10 integration tests pass. pyproject.toml updated with querysource
optional dep and entry_points. qw/conf.py updated with HANDLER_ENTRY_POINTS_GROUP.
362 total tests pass including all new FEAT-007 tests (no regression).
