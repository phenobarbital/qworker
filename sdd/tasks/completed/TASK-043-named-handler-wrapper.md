...
**Date**: 2026-05-26
**Notes**: All 16 unit tests pass. NamedHandlerWrapper extends QueueWrapper, stores
handler_name, args, kwargs. Internal QueueWrapper keys (queued, debug, id, container_config)
are stripped from self.kwargs so they don't pollute handler invocation. cloudpickle
roundtrip verified.
